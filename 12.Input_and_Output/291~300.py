...
# 005380
# 035420
f = open('D:/github/Python_Practice_300/12.Input_and_Output/Stock_name1.txt',
         mode = 'wt',
         encoding = 'utf-8')
f.write('005930\n')
f.write('005380\n')
...
# 005380 현대차
# 035420 NAVER
f = open('D:/github/Python_Practice_300/12.Input_and_Output/Stock_name2.txt',
         mode = 'wt',
         encoding = 'utf-8')
f.write('005930 삼성전자\n')
f.write('005380 현대차\n')
f.write('005420 NAVER\n')
f.close()
...
import csv
f = open('D:/github/Python_Practice_300/12.Input_and_Output/Stock_name1.csv',
         mode = 'wt',
         encoding = 'cp949',
         newline='')
write = csv.writer(f)
write.writerow(['종목명', '종목코드', 'PER'])
write.writerow(['삼성전자', '005930', 15.59])
