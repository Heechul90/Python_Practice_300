...
for i in range(len(data)):
    for k in range(len(data[0])):
        result.append(data[i][k]+(data[i][k]*수수료))
print(result)
...
for i in range(len(data)):
    list = []
    for k in range(len(data[0])):
        list.append(data[i][k]+(data[i][k]*수수료))
    result.append(list)
print(result)
...
volatility = []
for i in range(len(ohlc[1:])):
    volatility.append(ohlc[1:][i][1] - ohlc[1:][i][2])
print(volatility)
...
result = []
for i in range(len(ohlc[1:])):
    result.append(ohlc[1:][i][0] - ohlc[1:][i][3])
print(sum(result))