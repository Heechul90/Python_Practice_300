...
# >> 입력: 100 달러
# 116700.00 원
user = input('니가 가지고 있는 돈을 입력하시오: (100 달러)')
user = user.split(' ')
달러	= 1167
엔	= 1.096
유로	= 1268
위안	= 171
if user[1] == '달러':
    print(int(user[0])*달러, ' 원')
elif user[1] == '엔':
    print(int(user[0]) * 엔, ' 원')
elif user[1] == '유로':
    print(int(user[0]) * 유로, ' 원')
elif user[1] == '위안':
    print(int(user[0]) * 위안, ' 원')
...
# >> input number3: 20
# 20
number1 = int(input('숫자를 입력하시오1: '))
number2 = int(input('숫자를 입력하시오2: '))
number3 = int(input('숫자를 입력하시오3: '))
...
if user[:3] in ['010', '011', '012']:
    print('강북구')
elif user[0:3] in ['013', '014', '015']:
    print('도봉구')
elif user[0:3] in ['016', '017', '018', '019']:
    print('노원구')
...
user = input('주민등록번호를 입력하시오: ')
user = user[8:10]
if user in ['01', '02', '03', '04', '05', '06', '07', '08']:
    print('서울 입니다.')
elif user in ['09', '10', '11', '12']:
    print('부산 입니다.')
else:
    ('서울 및 부산이 아닙니다!')
...
# 유효하지 않은 주민등록번호입니다.
user = input('주민등록번호를 입력하시오: ')
user_calc = int(user[0])*2 + int(user[1])*3 + int(user[2])*4 + int(user[3])*5 + int(user[4])*6 + int(user[5])*7 + \
       int(user[7])*8 + int(user[8])*9 + int(user[9])*2 + int(user[10])*3 + int(user[11])*4 + int(user[12])*5
user_calc = 11 - (163 % 11)
if int(user[13]) == user_calc:
    print('유효한 주민등록번호입니다!')
else:
